...
public class Step01 {
    ...
    public static class MapperClass extends Mapper<LongWritable, Text, Text, Text> {
        ...
        public void map(LongWritable line_Id, Text line, Context context) throws IOException, InterruptedException {
            ...
            String lexeme1 = Utils.stemAndReturn(fields[0]).trim();
            String lexeme2 = Utils.stemAndReturn(fields[1]).trim();
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("[DEBUG] STEP 01 started!");
        ...
        */
        ...
        Job job = Job.getInstance(conf, "Step 01: creates lexemeSet");
        job.setJarByClass(Step01.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path(String.format("%s/outputs/output_step01", App.s3Path)));
